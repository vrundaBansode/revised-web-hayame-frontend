            ...
            <div className="login-container">
                <section className="login-wrapper">
                    <div className="login-heading">
                        ...
                        <p className="text text-normal">New user? <span><Link to="/register" style={{ color: "white" }}  className="text text-links" >Create an account</Link></span>
                        </p>
                    </div>
                    <form name="login" className="login-form">
                        <div className="login-input-control">
                            <label htmlFor="login-username" className="login-input-label" hidden>Email Address</label>
                            <input type="email" name="login-username" id="login-username" className="login-input-field" placeholder="Email Address" />
                        </div>
                        <div className="login-input-control">
                            <label htmlFor="login-password" className="login-input-label" hidden>Password</label>
