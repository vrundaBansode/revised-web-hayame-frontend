...
import { sectThreeIcon1, sectThreeIcon2, sectThreeIcon3 } from '../../../../../assets'
...
const SectThree = () => {
  ...
  const sectThreeContent = [
    ...
    },
    {
      ...
      content: "Workers choose their shifts that best fit their time and needs."
    },
    {
      icon: `${sectThreeIcon3}`,
  ...
  return (
    <div className='sect3-div'>
      <div className='sect3-card'>
        <h3 className='sect3-header'>Here's how we work!</h3>
